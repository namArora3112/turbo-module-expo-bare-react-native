...
/**
 * Metro config so the local package aep-turbo-core (file:.. symlink) can be resolved.
 * The symlink points to the parent directory; Metro must watch it to resolve modules.
 * Block parent's react-native and react so the app uses its own (Expo 51 / RN 0.74).
 */
